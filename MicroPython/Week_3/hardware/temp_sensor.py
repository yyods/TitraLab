    ...
    if temp_sensor.is_available:
        ...
        try:
            ...
            for i in range(5):
                ...
                formatted = temp_sensor.read_formatted()

                print(f"อ่านครั้งที่ {i+1}:")
        ...
        print("\nไม่สามารถทดสอบได้ - ไม่พบเซ็นเซอร์")
        print("(Cannot test - no sensor found)")
