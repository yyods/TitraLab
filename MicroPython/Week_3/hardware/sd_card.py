...
# ╚═════╝ ╚══════╝╚═╝     ╚═╝  ╚═╝╚══════╝ ╚═════╝╚═╝  ╚═╝   ╚═╝   ╚══════╝╚═════╝
# ==============================================================================
# ไฟล์นี้ถูกยกเลิกการใช้งาน - เก็บไว้สำหรับการอ้างอิงเท่านั้น
# THIS FILE IS DEPRECATED - KEPT FOR REFERENCE ONLY
# ==============================================================================
#
# เหตุผลที่ยกเลิก (Reason for deprecation):
...
#
# TitraLab board is always connected to laptop via USB, therefore:
# - CSV files are saved to ESP32 flash storage instead of SD Card
# - Students download files via Thonny IDE
# - Data analysis with EquivPoint tool on laptop
#
# สำหรับการบันทึกข้อมูล ใช้ core/titration.py แทน
# For data logging, use core/titration.py instead
#
# ==============================================================================
