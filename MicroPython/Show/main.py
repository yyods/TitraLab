...
push_button = Pin(35, Pin.IN)  # 23 number pin is input
...
def test():
    ...
    arcadepix = XglcdFont('fonts/EspressoDolce18x24.c', 18, 24)
    
    display.draw_text(80, 20, 'TitraLab 5555', arcadepix, color565(255, 255, 255))
    display.draw_text(10, 70, 'I am running MicroPython.', arcadepix, color565(255, 128, 0))
